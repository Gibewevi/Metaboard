        ...
        <div>
            <div className="w-full flex flex-col gap-y-3">
                <div className="flex flex-row">
                    <span className="text-3xl pr-3 text-[#ADB6C2] border-t-0 border-b-0 border-r-[1px] border-l-0 border-gray-700">{props.strategy}</span>
                    <div className="flex flex-row items-center gap-x-2 ml-4">
                        <div className="flex flex-row justify-center items-center gap-x-1 fill-[#00cfe8]">
                            ...
                            <span className="text-sm text-[#ADB6C2]">105</span>
                        </div>
                        <div className="flex flex-row justify-center items-center gap-x-1 fill-[#00cfe8]">
                            ...
                            <span className="text-sm text-[#ADB6C2]">54</span>
                        </div>
                        <div className="flex flex-row justify-center items-center gap-x-1 fill-[#00cfe8]">
                            ...
                            <span className="text-sm text-[#ADB6C2]">21</span>
                        </div>
                        <div className="flex flex-row justify-center items-center gap-x-1 fill-[#00cfe8]">
                            ...
                            <span className="text-sm text-[#ADB6C2]">33</span>
                        </div>
                    </div>
                </div>
